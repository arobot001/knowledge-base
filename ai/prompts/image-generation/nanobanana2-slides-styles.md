...
> - 作者：AAAAAAAJ
> - 来源：GitHub
> - 链接：https://github.com/AAAAAAAJ/slides
> - 整理时间：2026-03-27
...
一个生成多种风格 PPT 幻灯片的提示词集合，专为 NanoBanana2 (Gemini 3.1 Flash Image Preview) 设计。将复杂专业知识转化为干货内容，支持 11 种不同的视觉风格。
...
- 深炭色背景
- 霓虹发光效果
- 洋红 #FF00FF、青色 #00FFFF、黄色 #FFFF00
- 科技网格图案和电路装饰

---

### 4. 新粗野主义风格 (Neo-Brutalism)
**最佳场景：** 个性表达、艺术展示
...
### 5. 酸性图形 Y2K 风格 (Acid Graphics Y2K)
**最佳场景：** 潮流内容、年轻受众
...
### 7. 瑞士国际主义风格 (Swiss International)
**最佳场景：** 专业设计、高端展示
...
### 9. 设计蓝图风格 (Design Blueprint)
**最佳场景：** 产品文档、技术说明

```
Design blueprint PPT slide, Figma documentation style, White background with cyan grid lines #66B8CC, title text, subtitle below, Figma selection框 with control points, Annotation lines, numbered labels, Technical UI mockup aesthetic, Clean sans-serif Inter font, 16:9
```
...
### 10. 新粗野主义 UI 风格 (Neo-Brutalist UI)
**最佳场景：** 界面展示、SaaS 产品
...
### 最佳实践
- **Be specific** - "thick black outlines" 比 "bold lines" 效果更好
- **Always specify 16:9** - PPT 格式必备
- **Limit text** - AI 处理短文本效果更好
- **Use color names + hex** - "salmon pink #FF6B6B"
- **Iterate** - 小的提示词调整 = 不同的结果
...
1. 从 [PROMPTS.md](https://github.com/AAAAAAAJ/slides/blob/main/PROMPTS.md) 复制任意风格
2. 根据需要修改文字内容
3. 粘贴到 NanoBanana2 生成！
...
slides/
├── README.md          # 项目说明
├── PROMPTS.md         # 所有 11 种风格提示词
├── skill.json         # OpenClaw skill 配置
├── CLAUDE.md          # Skill 上下文
└── demos/yc-intro/images/  # 22 个生成示例
```
